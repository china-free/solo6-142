export type Element = 'address' | 'birthday' | 'categories' | 'company' | 'custom' | 'email' | 'fullname' | 'geo' | 'impp' | 'jobtitle' | 'key' | 'label' | 'logo' | 'name' | 'nickname' | 'note' | 'phoneNumber' | 'photo' | 'revision' | 'role' | 'social' | 'sortString' | 'timezone' | 'uid' | 'url';
...
export type PhoneType = 'pref' | 'work' | 'home' | 'voice' | 'fax' | 'msg' | 'cell' | 'pager' | 'bbs' | 'car' | 'modem' | 'isdn' | 'video';
